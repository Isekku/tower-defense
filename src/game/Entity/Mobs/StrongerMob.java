...
public class StrongerMob extends Mob implements AnimatedGif {
    ...
    public StrongerMob(Coordinates coordinates){
        super("Mob Fort", (stringGras + stringCouleurRouge), 20, 100, coordinates, 20, "resources/assets/monstres/4/S_Walk.gif", "resources/assets/monstres/4/S_Walk.gif", "resources/assets/monstres/4/S_Death.gif");
    }
