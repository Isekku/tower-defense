...
public class NormalMob extends Mob implements AnimatedGif {
    ...
    public NormalMob(Coordinates coordinates){
        super("Entite normal", stringGras, 12, 60, coordinates, 10, "resources/assets/monstres/2/S_Walk.gif", "resources/assets/monstres/2/S_Attack.gif", "resources/assets/monstres/2/S_Death.gif", 0.75f);
    }
