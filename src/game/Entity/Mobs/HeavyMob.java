...
public class HeavyMob extends Mob {
    ...
    public HeavyMob(Coordinates coordinates){
        super("Mob Lourd", stringCouleurRouge, 16, 160, coordinates, 75, "resources/assets/monstres/3/S_Walk.gif", "resources/assets/monstres/3/S_Attack.gif", "resources/assets/monstres/3/S_Death.gif", 0.15f);
    }
